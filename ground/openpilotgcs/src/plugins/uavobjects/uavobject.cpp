...
#define UAVOBJ_LOGGING_ACKED_SHIFT             5
...
/**
 * Get the UAVObject metadata Logging acked member
 * \param[in] metadata The metadata object
 * \return the Logging acked boolean
 */
quint8 UAVObject::GetLoggingAcked(const UAVObject::Metadata & metadata)
{
    return (metadata.flags >> UAVOBJ_LOGGING_ACKED_SHIFT) & 1;
}
...
/**
 * Set the UAVObject metadata Logging acked member
 * \param[in] metadata The metadata object
 * \param[in] val The Logging acked boolean
 */
void UAVObject::SetLoggingAcked(UAVObject::Metadata & metadata, quint8 val)
{
    SET_BITS(metadata.flags, UAVOBJ_LOGGING_ACKED_SHIFT, val, 1);
}
