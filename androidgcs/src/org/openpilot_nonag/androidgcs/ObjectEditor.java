...
public class ObjectEditor extends ObjectManagerActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		objectName = extras.getString("org.openpilot_nonag.androidgcs.ObjectName");
		objectID = extras.getLong("org.openpilot_nonag.androidgcs.ObjectId");
		instID = extras.getLong("org.openpilot_nonag.androidgcs.InstId");
