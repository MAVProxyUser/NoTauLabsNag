...
import org.openpilot_nonag.androidgcs.util.ObjectFieldMappable;
...
public class DropdownBoxView extends GridLayout implements ObjectFieldMappable {

	private final static String TAG = DropdownBoxView.class.getSimpleName();
...
//	private final Spinner spinner;
	...
	public DropdownBoxView(Context context, AttributeSet attrs) {
		super(context, attrs);
