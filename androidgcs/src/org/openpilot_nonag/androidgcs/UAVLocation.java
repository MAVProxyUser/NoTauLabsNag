...
public class UAVLocation extends ObjectManagerActivity implements
	...
	public void onCreate(Bundle icicle) {
		...
		getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON); // disable
																				// sleep
		...
		UAVpathLine = mMap.addPolyline(new PolylineOptions().width(5).color(
				Color.WHITE));
		UAVpathLine.setPoints(UAVpathPoints);
		NEDUAVpathLine = mMap.addPolyline(new PolylineOptions().width(5).color(
				Color.RED));
		NEDUAVpathLine.setPoints(NEDUAVpathPoints);
		TabletpathLine = mMap.addPolyline(new PolylineOptions().width(5).color(
				Color.BLUE));
