...
public class OldHomePage extends ObjectManagerActivity {
	@Override
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		objectBrowser.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				startActivity(new Intent(OldHomePage.this, ObjectBrowser.class));
			}
		});
		...
		pfd.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View arg0) {
				startActivity(new Intent(OldHomePage.this, PfdActivity.class));
			}
		});
		...
		tfr.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View arg0) {
				startActivity(new Intent(OldHomePage.this, TfrActivity.class));
			}
		});
                ...
                location.setOnClickListener(new OnClickListener() {
                        @Override
                        public void onClick(View arg0) {
                                startActivity(new Intent(OldHomePage.this, UAVLocation.class));
                        }
                });
        	...
        	command_center.setOnClickListener(new OnClickListener() {
                	@Override
                	public void onClick(View arg0) {
                	        startActivity(new Intent(OldHomePage.this, ControlCenterActivity.class));
                	}
        	});
		...
		wizard.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View arg0) {
				startActivity(new Intent(OldHomePage.this, Wizard.class));
			}
		});
		...
		logger.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View arg0) {
				startActivity(new Intent(OldHomePage.this, Logger.class));
			}
		});
		...
		alarms.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View arg0) {
				startActivity(new Intent(OldHomePage.this, SystemAlarmActivity.class));
			}
		});
		...
		tuning.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View arg0) {
				startActivity(new Intent(OldHomePage.this, TuningActivity.class));
			}
		});
